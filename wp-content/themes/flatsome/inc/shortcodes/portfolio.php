            ...
            <div class="<?php echo implode(' ', $classes_box); ?>">
              ...
              <div class="<?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
                <div class="box-text-inner">
                  <h2 class="uppercase portfolio-box-title" style="font-weight: 400;"><?php the_title(); ?></h2>
                  <?php $portfolio_date = get_the_date($entry->post_date); ?>
                  <div style="display: flex; align-items:center; margin: 5px 0;" class='date-container minor-meta portfolio-posted-on'> <?php echo $portfolio_date ?></div>
                  <div class="portfolio_excerpt" style="font-size: 16px;">
                    <?php the_excerpt(); ?>
                  </div>
                  <div class="divider" style="display: none;width:100%;height:1px;background-color:#C5C5C5;margin: 1.5rem 1rem 0 0;"></div>
                  <button lang="vi" style="float:right; 
                          text-transform:none;
                          font-weight:400;
                          font-size: 1em;
                          padding: 7px 15px;
                          border: none;
                          border-radius: 8px;" href="<?php echo $link; ?>" class="translate_str button secondary is-shade is-small mb-0">
                    Xem thêm
                  </button>
                  <button lang="en-GB" style="float:right; 
                          text-transform:none;
                          font-weight:400;
                          font-size: 1em;
                          padding: 7px 15px;
                  ...
                  <button lang="km" style="float:right; 
                          text-transform:none;
                          font-weight:400;
                          font-size: 1em;
                          padding: 7px 15px;
...
<?php
    ...
    endwhile;
    // if (function_exists('devvn_wp_corenavi')) devvn_wp_corenavi(); 
    page_nav();
  endif;
